...
\newif\iffaq\faqfalse %false - testing - available online
\newif\iftroubleshooting\troubleshootingfalse %false 
...
\ifrendereverything \titletrue \copyrighttrue \warningstrue \setuptrue  \softwaretrue \curatrue \slicertrue \filamenttrue \firstprinttrue \maintenancetrue \advancedtrue \faqtrue \troubleshootingtrue \sourcetrue \supporttrue \warrantytrue \colophontrue \fi
%%% END INCLUDED FILES %%%
...
\thispagestyle{empty}
\markboth{Warranty Information}{LulzBot\textsuperscript{\miniscule{\texttrademark}} TAZ User Manual}
{\include{Warranty}}
\fi
%%% END SUPPORT %%%
