...
Before you start printing you will need to load a reel of filamant onto the reel holder. If mounted correctly the reel holder will keep the filament reel rotating smoothly. The reel holder is meant to work with 1kg and 5lb plastic filament reels but can be modified the work with other reel and spool types.
