...
\section{Graphical LCD Controller, Cura or Other Host?}
...
\section{Saving Print Files to the SD Card}
\index{sd card}
...
\section{Printing With the Graphical LCD Controller}
\begin{figure}[b]
\centering
...
\subsection{The Graphical LCD Controller Status Screen}
...
\subsection{Making Manual Movements With the Graphical LCD Controller}
...
\subsection{Changing EEPROM Settings}
...
\subsection{Graphical LCD Controller Menu Map}
\begin{figure}[H]
\centering
