...
\item Connect the stepper motor and the hot end to the existing wiring harness located at the top of the X axis carriage. Connect the matching male and female connectors with red/orange wires for the hot end and the other male and female connectors for the extruder motor (Fig. \ref{fig:tool_head_connectors}, page \pageref{fig:tool_head_connectors}). Make sure the connector locks click to be sure that the connections are secure.
