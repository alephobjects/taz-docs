...
\item Locate one of the three small black zip ties that are included in the documents bag. Wrap and tighten the zip tie around the Y axis wiring and the black Y axis frame extrusion as shown in figure \ref{fig:bed_connectors} (page \pageref{fig:bed_connectors}).
