...
\includegraphics[keepaspectratio=true,angle=0,height=1.0\textheight,width=1.0\textwidth]{New_Outage_6.svg}
\end{center}
\begin{center}
\fontspec{Outage.ttf}\fontsize{24pt}{1em}\selectfont Manual
\end{center}
...
%%% SET TITLE FONT
\includegraphics[keepaspectratio=true,angle=0,height=1.0\textheight,width=1.0\textwidth]{Juniper_2_Transparent.png}
