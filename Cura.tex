...
\index{filament}
We have the different filaments separated by \texttt{Material ease of use.} From the \texttt{Material ease of use} drop down, select \texttt{"All"} to view all our pre-loaded filament slicing profiles. The TAZ ships with a 1 meter sample of nGen for the first print.
...
Each individual extruder will have its own unique set of Extruder steps per unit, or Esteps. Your V2 Dual Extruder was calibrated before leaving the production floor. The number for each extruder will be located on the back of the tool head. This will need to be updated within your printer's firmware.
\begin{itemize}
