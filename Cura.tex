...
\index{Temperatures}
When preparing your printer for operation, please be sure to set your temperatures, in Celcius, to the specific filament you are using. 
\begin{center}
 \hspace*{-1.25cm}\begin{tabular}{||c c c c c||} 
 \hline
