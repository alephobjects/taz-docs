...
\item Switch to the other toolhead by entering "\texttt{T0}" for the rear or "\texttt{T1}" for the front. 
...
After printing the squares, you will want to measure Top, Bottom, Left, and Right gap. Enter these numbers into our offset calculator found here: \textcolor{red}{(https://www.lulzbot.com/dual-extruder-calibration-calculator)} This will produce new offsets, that will need to be updated in the Machine Settings menu. Repeat as many times as desired to truely fine tune the offset. 
