...
This is where you will set the hot end temperature for your specific material. It will be pre-set when using the recommended quickprint profiles. This can be adjusted for fine tuning of different filament manufacturers to help layer adhesion or stringing. See Recommended Temperatures Table: page \pageref{tab:a}.
...
This is where you will set the heat bed temperature for your specific material. These will be pre-set when using the recommended quickprint profiles. This can be adjusted for fine tuning of different filament manufacturers to help adhesion or release. See Recommended Temperatures Table: page \pageref{tab:a}.
