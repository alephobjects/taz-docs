...
\index{maintenance}
Little maintenance is required keep your LulzBot\textsuperscript{\miniscule{\texttrademark}} TAZ 3D printer running. Depending on your rate of use you will want to perform a quick check of your printer every 2 to 4 weeks. The following maintenance guidelines will keep your printer printing quality parts.
...
\index{electronics}
\index{fan}
The electronics case holding the RAMBo board may need dust blown out occasionally. Power down the printer and use the provided 2.5-mm driver to remove the four M3 screws securing the lid. \textcolor{red}{The fan is mounted to the lid and connected to the RAMBo board. Be careful with the fan cable during removal}. Once removed, use short bursts of compressed air to blow out any dust. Plug in the lid fan, paying attention to polarity, and reattach the lid.
