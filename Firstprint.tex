...
This file can be found at: \texttt{http://download.lulzbot.com/TAZ/calibration/bed\_level.gcode} once downloaded you your computer press the \texttt{Load file} button. Navigate through the file browser to the downloaded \texttt{bed\_level.gcode} file, highlight the file and select the \texttt{Open} button.
