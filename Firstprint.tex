...
With the Z axis lowered near the bed, use the included \textt{150mm ruler} to measure the distance from the bottom of the \texttt{X axis} smooth rod and the top surface of the \texttt{Y axis} aluminum bed plate.
\begin{figure}[hbt]
\centering
