...
\section{Gluestick/PVA Glue solution}
...
%\index{PTFE tube}
\glossary{PTFE}{Polytetrafluoroethylene is a synthetic fluoropolymer used in the Budaschnozzle for it's low coefficient of friction. This limits the Budaschnozzle top extrusion temperature to 250C. The TAZ 5 does not use a hot end with a PTFE insert and can reach a \texttt{300°C} extrusion temperatuere.}
