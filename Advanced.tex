...
After becoming familiar with printing with the TAZ 3D printer with the default settings there are a few advanced techniques that may help in getting better and more consistent prints. Some of this instructions include items and materials not included with the TAZ. With any of these additional items or materials, follow safety and usage guidelines as instructed by the manufacturer.
...
To change the nozzle you will need the 18mm and 13mm wrench from the printer tool kit. Slide the 18mm wrench onto the rectangular aluminum heater block away from the heater resistor and thermistor wires.
