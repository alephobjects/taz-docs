...
\glossary{ABS}{Acrylonitrile butadiene styrene thermoplastic. Usually extrudes at 230C with the Budaschnozzle and 245C with the LulzBot\textsuperscript{\miniscule{\texttrademark}} Hexagon Hot End.}
\glossary{PLA}{Polylactic acid is a corn-based biodegradable polymer. Usually extrudes at \texttt{185°C} with the Budaschnozzle and \texttt{205°C} with the LulzBot\textsuperscript{\miniscule{\texttrademark}} Hexagon Hot End.}
...
\glossary{HIPS}{High-impact polystyrene. Usually extrudes at \texttt{230°C} with the Budaschnozzle and \texttt{230°C} with the LulzBot\textsuperscript{\miniscule{\texttrademark}} Hexagon Hot End}
...
After you become familiar with printing using the default settings, a few advanced techniques may help in getting better and more consistent prints from the LulzBot\textsuperscript{\miniscule{\texttrademark}} TAZ 3D printer. Some of these instructions are items and materials not included with the TAZ. With any of these additional items or materials, follow safety and usage guidelines as instructed by the manufacturer.
...
\index{hot end}
\glossary{Hot end}{The hot end is the whole part where the plastic melts, including the nozzle, heater block, thermistor, and heat sink. The LulzBot\textsuperscript{\miniscule{\texttrademark}} Hexagon Hot End comes standard on the TAZ 5.}
...
Acetone is not included or required with the LulzBot\textsuperscript{\miniscule{\texttrademark}} TAZ 3D printer. \textcolor{red}{Acetone and ABS solution is NOT recommended anymore, as the PEI print surface works well without it.}

\subsection{\texttt{Gluestick/PVA Glue solution}}
...
\index{Nylon}
\index{gluestick}
\glossary{PVA}{Polyvinyl acetate is the main ingrediant in white glue, wood glue and the common school glue stick.} While almost all 3D printing filaments will adhere well to the PEI print surface, Nylon print adhesion can be improved with the application of a PVA glue solution/gluestick. Flexible filaments such as Ninjaflex can adhere too well and can be released more easily from the PEI print surface with an application of a PVA glue solution/gluestick to the heated bed prior to starting the printing process.
