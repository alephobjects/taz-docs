...
\index{Nylon}
\index{gluestick}
\glossary{PVA}{Polyvinyl acetate is the main ingrediant in white glue, wood glue and the common school glue stick.} While almost all 3D printing filaments will adhere well to the PEI print surface, Nylon print adhesion can be improved with the application of a PVA glue solution/glue stick. Flexible filaments such as NinjaFlex and SemiFlex can adhere too well and can be released easier from the PEI print surface with an application of a PVA glue solution/glue stick to the heated bed prior to starting the printing process.
