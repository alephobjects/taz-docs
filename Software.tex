...
\glossary{free/libre}{Free/Libre hardware and software can be thought of as "free as in free speech, not free as in free beer", although most free/libre software is available for no cost. Libre hardware designs can be copied, modified and are usually available for download. Free/Libre software can be used, copied and modified in a similar fashion.}
...
\index{Windows}
\index{Macintosh}
Website: \texttt{free-cad.sourceforge.net}
