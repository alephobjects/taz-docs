...
\subsubsubsection{Plastic shrinkage}
...
\subsubsubsection{More material is deposited in the inside}
...
\subsubsubsection{Curves are approximated by polygons}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=1\textwidth]{advanced/troubleshooting/polygonal-hole.png}
...
\subsubsubsection{Filament tends to cut corners}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=1\textwidth]{advanced/troubleshooting/z-wobble.png}
\caption{Z wobble changing layer stacking.}
\label{fig:z-wobble}
\end{figure}

\subsubsubsection{Non-regular filament section}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=1\textwidth]{advanced/troubleshooting/irregular-filament.png}
