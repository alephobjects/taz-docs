...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=.33\textwidth]{advanced/flow_math/extrusion-width.png}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=.33\textwidth]{advanced/flow_math/bridge.png}
...
\verb|Extrusion Width is the thickness of a single filament extruded either in free air or above a surface. It's not the distance of two adjacent paths since some overlap will be generally applied in order to get better bonding.|
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=.33\textwidth]{advanced/flow_math/area1.png}
