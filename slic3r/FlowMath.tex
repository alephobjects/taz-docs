...
\par \verb|E = f(extrusion_width, layer_height)|
...
\par \verb|void_area = layer_height\^{2} - (layer_height/2)\^{2} * PI|
...
\par \verb|0 \textless overlap_factor*void_area \textless void_area|
...
\par \verb|spacing = extrusion_width - layer_height * (1 - PI/4)|
...
\verb| nozzle_diameter * 1.7|, except for internal sparse infill where the full native flow is used.
