...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=0.75\textwidth]{advanced/support/advanced_support.png}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=0.75\textwidth]{advanced/support/support_minimug_45deg.png}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=0.2\textwidth]{advanced/support/support_pattern_rectlinear.png}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=0.2\textwidth]{advanced/support/support_pattern_rectlinear_grid.png}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=0.2\textwidth]{advanced/support/support_pattern_honeycomb.png}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio=true,width=0.2\textwidth]{advanced/support/support_pattern_rectlinear_rotated.png}
