...
The 3D model files may come from an online repository, such as Thingiverse\footnote{\	exttt{http://www.thingiverse.com}} or GrabCAD\footnote{\	exttt{http://grabcad.com}}, or be created from a CAD program, such as FreeCAD\footnote{\	exttt{http://sourceforge.net/projects/free-cad}}, Sketchup\footnote{\	exttt{http://www.sketchup.com}}, or OpenSCAD\footnote{\	exttt{http://www.openscad.org}}, or an online CAD tool such as Shapesmith\footnote{\	exttt{http://shapesmith.net}}.

You may wish to view the files before slicing and there are many free applications available, one of which is Meshlab\footnote{\	exttt{http://www.meshlab.org}} - a comprehensive tool for viewing and working with 3D files.
